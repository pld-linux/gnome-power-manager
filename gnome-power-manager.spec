...
Source0:	ftp://ftp.gnome.org/pub/gnome/sources/gnome-power-manager/2.17/%{name}-%{version}.tar.bz2
# Source0-md5:	ac47215e0ac15d7eb39c31c1ce719111
...
BuildRequires:	gtk+2-devel >= 1:2.10.9
...
Requires:	gnome-session >= 2.17.92
